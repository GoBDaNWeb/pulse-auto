...
export const validInputs = () => {
  ...
  let inputsValidYear = document.querySelectorAll(
    ".input__valid-year"
  );
  let inputsValidMileage = document.querySelectorAll(
    ".input__valid-mileage"
  );
  ...
  inputsValidYear.forEach((input) =>
    input.addEventListener("input", checkPositiveNumber)
  );
  inputsValidMileage.forEach((input) =>
    input.addEventListener("input", checkPositiveNumber)
  );
